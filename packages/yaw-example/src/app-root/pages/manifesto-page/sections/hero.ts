...
@Component({
    ...
    `,
    styles: `
        :host { display: block; min-height: calc(100vh / var(--zoom, 1.75)); display: flex; align-items: center;
        ...
        .title { font-size: clamp(3rem, calc(10vw / var(--zoom, 1.75)), 7rem); font-weight: 900; color: #fff;
