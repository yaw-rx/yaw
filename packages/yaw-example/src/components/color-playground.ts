...
const styles = `
    color-playground { display: block; color: #ccc; }
    color-playground h1 { color: #fff; font-size: 2rem; font-weight: 900;
                          letter-spacing: -1px; margin: 0 0 0.75rem; }
    color-playground .lede { color: #888; line-height: 1.7; margin-bottom: 2rem; max-width: 72ch; }
    color-playground .inline { background: #111; padding: 0.1rem 0.4rem;
                               border-radius: 3px; font-size: 0.9em; color: #8af; }
    color-playground h2 { color: #fff; font-size: 1.1rem; font-weight: 700;
                          margin: 0 0 1rem; letter-spacing: 0.02em; }
    color-playground .host, color-playground .ex { margin-bottom: 1.5rem; padding: 1.25rem;
    ...
    color-playground .live label { color: #888; font-size: 0.8rem;
                                   font-family: monospace; text-transform: uppercase;
                                   letter-spacing: 0.08em; }
    color-playground .live em { color: #8af; font-style: normal; }
    color-playground .live .out { grid-column: 1 / -1; background: #0a0a0a;
                                  padding: 0.6rem 0.75rem; border-radius: 4px;
                                  color: #8af; font-family: monospace; font-size: 0.8rem;
                                  border: 1px solid #1a1a1a; }
    color-playground .live .swatch { grid-column: 1 / -1; border-radius: 8px;
